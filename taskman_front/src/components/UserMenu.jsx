    ...
    <Menu as="div" className="relative ml-3">
      <div>
        <Menu.Button className="flex items-center gap-x-2 rounded-full bg-white dark:bg-gray-800 
          ...
          <div className="absolute -bottom-1 -right-1 h-2 w-2 rounded-full bg-green-400 
      ...
      >
        <Menu.Panel className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y 
