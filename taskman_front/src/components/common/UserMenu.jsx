...
const UserMenu = () => {
  ...
  return (
    <Menu as="div" className="relative ml-3">
      <Menu.Button
        className="flex items-center gap-x-2 rounded-full bg-white dark:bg-gray-800 
      ...
      >
        <div className="px-4 py-3">
          ...
          <div className="mt-2">
            <span
              className="inline-flex items-center rounded-full bg-green-50 dark:bg-green-900/20 
